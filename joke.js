const arr= ["What do kids play when their mom is using the phone? Bored games.",
    ...
    "A short joke about storm clouds and weather rainCanva/Parade",
